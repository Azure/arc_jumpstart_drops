...
| `Products` | A list of products and services used in the Drop. Contributors can add their own if necessary. | No | Array | Maximum 3 items in the array.<br>Examples of Products: Azure Arc, AKS, Windows IoT, SQL Server, Arc-enabled service, App Services, VMware |
