...
> ⚠️ **Disclaimer:** For further details and updates on availability, please refer to the [Secret Store extension Documentation](https://learn.microsoft.com/azure/azure-arc/kubernetes/secret-store-extension).
